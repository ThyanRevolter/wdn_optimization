...
chapter54_test_cases = [
    pytest.param(
        ...
        np.array([21.269, 9.844, 11.426, 6.029, 6.066, 3.388, 0.359, 1.066, 0.185, 0.545, 6.731]),
...
@pytest.fixture
def wn_chapter534():
    return WaterNetwork("data/epanet_networks/chapter_5_3_4_example.inp", units=Units.IMPERIAL_CFS, round_to=5)

@pytest.fixture
def wn_chapter54():
    return WaterNetwork("data/epanet_networks/chapter_5_4_example.inp", units=Units.IMPERIAL_CFS, round_to=5)

@pytest.mark.parametrize("initial_flow,initial_head,expected_flow,expected_head", chapter534_test_cases)
def test_chapter534(wn_chapter534, initial_flow, initial_head, expected_flow, expected_head):
    """Test cases for chapter 5.3.4 example"""
    final_flow, final_head = wn_chapter534.run_newton_raphson(initial_flow, initial_head)
...
@pytest.mark.parametrize("initial_flow,initial_head,expected_flow,expected_head", chapter54_test_cases)
def test_chapter54(wn_chapter54, initial_flow, initial_head, expected_flow, expected_head):
